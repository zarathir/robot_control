...
const CommandRequest$json = const {
  '1': 'CommandRequest',
  '2': const [
    const {'1': 'linear', '3': 1, '4': 1, '5': 11, '6': '.teleop.Vector3', '10': 'linear'},
    const {'1': 'angular', '3': 2, '4': 1, '5': 11, '6': '.teleop.Vector3', '10': 'angular'},
  ],
};

/// Descriptor for `CommandRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List commandRequestDescriptor = $convert.base64Decode('Cg5Db21tYW5kUmVxdWVzdBInCgZsaW5lYXIYASABKAsyDy50ZWxlb3AuVmVjdG9yM1IGbGluZWFyEikKB2FuZ3VsYXIYAiABKAsyDy50ZWxlb3AuVmVjdG9yM1IHYW5ndWxhcg==');
...
final $typed_data.Uint8List commandAckDescriptor = $convert.base64Decode('CgpDb21tYW5kQWNrEhgKB3N1Y2Nlc3MYASABKAhSB3N1Y2Nlc3M=');
